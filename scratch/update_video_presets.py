...
new_video_presets_code = '''import 'package:procut/core/config/server_config.dart';
...
with open('lib/features/ai_video_edit/data/ai_video_presets_data.dart', 'w') as f:
    f.write(new_video_presets_code)

print("Updated ai_video_presets_data.dart with 20 hyper-specific cinematic video presets!")
