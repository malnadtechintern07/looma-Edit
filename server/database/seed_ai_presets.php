...
$presets = [
    ...
    [
        ...
        'negative_prompt' => 'cartoonish, blurry, low resolution, flickering artifacts, distorted anatomy, jittery motion, watermark, plastic textures',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/cyberpunk_arcade.mp4',
        'model_name' => 'Runway Gen-3 Alpha',
        'style' => 'Cyberpunk Photorealism',
        'camera_movement' => 'Continuous Tracking Dolly Forward with Anamorphic Flares',
    ...
    [
        ...
        'negative_prompt' => 'overexposed, CGI look, pixelated, jitter, stuttering motion, washed out, watermark, cartoon render, blurred peaks',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/alps_drone.mp4',
        'model_name' => 'OpenAI Sora',
        'style' => 'Cinematic Landscape FPV',
        'camera_movement' => 'High-Speed Aerobatic FPV Drone Ridge Dive',
    ...
    [
        ...
        'negative_prompt' => 'flat lighting, noise, artifacts, static camera, synthetic CGI sheen, bad anatomy, deformed hands, cold lighting',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/ramen_bar.mp4',
        'model_name' => 'Luma Dream Machine',
        'style' => 'Warm Cinematic Documentary',
        'camera_movement' => 'Slow Steadicam Push-In with Ultra-Shallow Macro Depth of Field',
    ...
    [
        ...
        'negative_prompt' => 'shaky camera, jump cuts, digital noise, muddy shadows, low resolution, compression artifacts, blurred umbrellas',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/tokyo_shinjuku.mp4',
        'model_name' => 'Kling AI 1.5',
        'style' => 'Urban Cyberpunk Hyperlapse',
        'camera_movement' => 'Dynamic Robotic Slider Forward Hyperlapse at Eye Level',
    ...
    [
        ...
        'negative_prompt' => 'jerky camera, unnatural physics, broken motion, cartoon render, watermark, blurriness, deformed shoes, flat shadows',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/urban_skate.mp4',
        'model_name' => 'Pika 2.0 Pro',
        'style' => 'Action Sports 120fps Slow-Mo',
        'camera_movement' => 'Ultra-Low Ground-Skimming Tracking Cam with Sunburst Flare',
    ...
    [
        ...
        'negative_prompt' => 'deformed faces, static mannequins, muddy blacks, oversaturation, blur, modern cars, anachronistic objects, flat lighting',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/tokyo_street.mp4',
        'model_name' => 'Runway Gen-3 Alpha',
        'style' => '35mm Film Cinematic Street',
        'camera_movement' => 'Slow Steadicam Glide Down Atmospheric Pedestrian Alley',
    ...
    [
        ...
        'negative_prompt' => 'low-poly, flat lighting, jittery stars, blurry cockpit, amateur CGI, watermark, video game look, bad textures',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/overlay_vid.mp4',
        'model_name' => 'OpenAI Sora 2.0',
        'style' => 'Interstellar Hard Sci-Fi',
        'camera_movement' => 'Accelerating Cockpit Push-In to Light Speed Warp',
    ...
    [
        ...
        'negative_prompt' => 'dirty camera lens, digital grain noise, poor motion physics, distorted reflections, watermark, blurry ripples',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/tokyo_shinjuku.mp4',
        'model_name' => 'Kling AI 1.5',
        'style' => 'Dark Atmospheric Cyberpunk',
        'camera_movement' => 'Probe Lens Millimeter Skim with Seamless Tilt-Up',
    ...
    [
        ...
        'negative_prompt' => 'choppy frame rate, compression artifacts, flat mountains, unnatural snow color, oversaturated sky, camera shudder',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/alps_drone.mp4',
        'model_name' => 'Runway Gen-3 Alpha',
        'style' => 'National Geographic Aerial 8K',
        'camera_movement' => '360-Degree Gyro-Stabilized Helicopter Circling Orbit',
    ...
    [
        ...
        'negative_prompt' => 'blown out highlights, muddy shadows, stuttering car wheels, digital artifacts, blur, modern vehicles, cheap CGI',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/urban_skate.mp4',
        'model_name' => 'Luma Dream Machine',
        'style' => 'West Coast Nostalgic 70mm',
        'camera_movement' => 'Parallel Wheel-Level Rolling Shot with Horizon Breathing',
    ...
    [
        ...
        'negative_prompt' => 'flat textures, broken lightning geometry, poor smoke simulation, cartoon look, low frame rate, videogame graphics',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/cyberpunk_arcade.mp4',
        'model_name' => 'Pika 2.0 Pro',
        'style' => 'Futuristic Quantum Physics Lab',
        'camera_movement' => 'Sweeping Crane Descent Circling Particle Accelerator Ring',
    ...
    [
        ...
        'negative_prompt' => 'synthetic flowers, unnatural petal physics, bad lighting, blur, artifacts, glitch, daylight bleed, pixelated blossoms',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/tokyo_street.mp4',
        'model_name' => 'OpenAI Sora',
        'style' => 'Ethereal Japanese Cinematic Poetry',
        'camera_movement' => 'Gentle Dolly Drift Down Canal Walkway with Water Reflections',
    ...
    [
        ...
        'negative_prompt' => 'static vehicle, bad wheel physics, cartoon textures, muddy night shadows, jittery tracking, low frame rate',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/cyberpunk_arcade.mp4',
        'model_name' => 'Runway Gen-3 Alpha',
        'style' => 'High-Octane Cyberpunk Chase',
        'camera_movement' => 'Low Ground Chase Cam Tracking Exhaust at 200 km/h',
    ...
    [
        ...
        'negative_prompt' => 'murky muddy water, CGI plastic skin, distorted anatomy, aquarium walls, floating debris, artificial look, washed out colors',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/alps_drone.mp4',
        'model_name' => 'OpenAI Sora 2.0',
        'style' => 'National Geographic Deep Ocean',
        'camera_movement' => 'Slow Orbit Gliding Alongside Colossal Leviathan',
    ...
    [
        ...
        'negative_prompt' => 'modern clothing, bad katana geometry, plastic armor, western swords, jittery camera, blurry bamboo, anime look',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/tokyo_street.mp4',
        'model_name' => 'Kling AI 1.5',
        'style' => 'Feudal Japanese Kurosawa Epic',
        'camera_movement' => 'Slow 360 Steadicam Arc Around Ready Katana Guard',
    ...
    [
        ...
        'negative_prompt' => 'grainy noisy sky, static aurora, overexposed stars, choppy water, flat lighting, artificial CGI glow, digital compression',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/alps_sunrise.mp4',
        'model_name' => 'OpenAI Sora',
        'style' => 'Nordic Midnight Expedition',
        'camera_movement' => 'Prow Camera Drifting Across Mirrored Glacial Fjord',
    ...
    [
        ...
        'negative_prompt' => 'modern cars, realistic daytime, washed out colors, low contrast, pixelated car model, blurry grid, cartoon render',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/urban_skate.mp4',
        'model_name' => 'Pika 2.0 Pro',
        'style' => '1980s Retro Synthwave Cinema',
        'camera_movement' => 'Rear 3/4 Tracking Shot Following Chrome Exhaust and Spoiler',
    ...
    [
        ...
        'negative_prompt' => 'greenery, modern buildings, static dust, fake CGI sand, cartoon look, flat lighting, digital noise, blurry dunes',
        'reference_image_url' => '',
        'preview_video_url' => 'assets/demo/alps_drone.mp4',
        'model_name' => 'OpenAI Sora 2.0',
        'style' => 'Lawrence of Arabia Epic Cinema',
        'camera_movement' => 'Slow Sweeping Crane Pull-Back Amidst Swirling Dust',
